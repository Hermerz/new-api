      ...
      cover={
        <div
          ...
          style={{
            ...
            backgroundImage: `linear-gradient(0deg, rgba(var(--palette-primary-darkerChannel) / 80%), rgba(var(--palette-primary-darkerChannel) / 80%)), url('/newapi-admin/cover-4.webp')`,
